...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FBF9F5] text-[#0F172A] flex flex-col antialiased selection:bg-red-100 selection:text-[#B42318] [scrollbar-gutter:stable] overflow-x-hidden w-full">
