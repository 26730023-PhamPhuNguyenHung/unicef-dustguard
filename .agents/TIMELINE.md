...
|---|:---:|---|---|
| **2026-09-02** | `HEAD` | `chore(cleanup): purge 300+ unused landing assets and prune redundant public images` | Xóa sạch 301 tệp ảnh tĩnh/preview rác (~7.55 MB) trong `app/public/assets/landing`, gỡ bỏ `landingAssets.js`, dọn dẹp ảnh dư thừa trong `images/` và chuẩn hóa logo thương hiệu về `images/logo/dustguard-shield-logo.webp` (giúp tốc độ build Vite tăng từ 3.28s xuống 1.90s). |
